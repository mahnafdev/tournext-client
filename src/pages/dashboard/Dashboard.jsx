	...
	return (
		...
		>
			...
			<div className="grid grid-cols-5 lg:grid-cols-4 gap-4">
				{/* Card Stats */}
				<div className="col-span-5 lg:col-span-4 grid md:grid-cols-2 xl:grid-cols-4 gap-2 md:gap-4">
					{/* Total Bookings */}
				...
				{/* Visuals & Analytics */}
				{/* Users by Role */}
				<div className="col-span-5 md:col-span-4 lg:col-span-3 2xl:col-span-2 p-6 bg-base-300 border border-primary/30 rounded-2xl flex flex-col gap-y-4">
					<h4 className="text-2xl font-semibold text-zinc-300 capitalize">
						Users by Role
					</h4>
					{/* Vertical Bar Chart */}
